...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      "نحصل على عمولة عند فتحك حساباً لدى شركة تداول عبر روابط الإحالة الموجودة في المنصة. هذه العمولة تدفعها الشركة من فرق السعر أو العمولة التي تتقاضاها أصلاً، ولا تُضاف إلى تكلفة تداولك.",
      "وهذا يعني أن لدينا مصلحة مالية في بعض الشركات المعروضة. لذلك: الشركات التي لدينا معها اتفاقية تظهر موسومة بوضوح بـ«شريك معتمد»، وندرج إلى جانبها شركات لا نتعاقد معها، والتقييمات تُبنى من مراجعات المستخدمين لا منّا. تفاصيل منهجيتنا كاملة في صفحة «من نحن».",
    ],
  },
  {
