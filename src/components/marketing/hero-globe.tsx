      ...
      <svg viewBox="0 0 520 520" className="relative h-full w-full">
        <defs>
          <radialGradient id="fxg-sphere" cx="36%" cy="30%" r="72%">
            <stop offset="0%" stopColor="var(--c-globe-1)" />
            <stop offset="42%" stopColor="var(--c-globe-2)" />
            <stop offset="78%" stopColor="var(--c-globe-3)" />
            <stop offset="100%" stopColor="var(--c-globe-4)" />
          </radialGradient>
        ...
        <g transform="translate(260,260)">
          ...
          {/* Latitudes */}
          <g fill="none" stroke="var(--c-globe-line)" strokeWidth="1">
          ...
          {/* Network links */}
          <g stroke="var(--c-globe-line)" strokeWidth="1.2" opacity=".75" filter="url(#fxg-glow)" fill="none">
          ...
          {/* Network nodes */}
          <g fill="var(--c-globe-node)" filter="url(#fxg-glow)">
          ...
          <circle cx="0" cy="-196" r="6" fill="var(--c-globe-spark)" filter="url(#fxg-glow)" />
        </g>
      </svg>
    </div>
  );
