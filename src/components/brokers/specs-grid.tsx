              ...
              return (
                <td key={b.id} className="p-3 text-center">
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-1.5 rounded-xl bg-brand-gradient px-3 py-2 text-xs font-semibold text-ink-900 shadow-glow transition hover:opacity-90"
                  >
                    فتح حساب
