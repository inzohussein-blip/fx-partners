...
const SEGMENTS = [
  { key: "active", label: "نشط", color: "#54D8F0" },
  { key: "funded", label: "مموّل", color: "#f5c451" },
  { key: "registered", label: "مسجّل", color: "#54D8F0" },
      ...
      <div className="card-surface p-6 lg:col-span-2">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-white/5 bg-ink-900/40 p-4">
            ...
            <div className="mt-2">
              <Sparkline values={series.map((s) => s.earnings)} color="#54D8F0" />
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/5 bg-ink-900/40 p-4">
            ...
            <div className="mt-2">
              <Sparkline values={series.map((s) => s.referrals)} color="#0090FC" />
            </div>
          </div>
