            ...
            >
              <defs>
                <linearGradient id="earnGrad" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#54D8F0" stopOpacity={0.5} />
                  <stop offset="100%" stopColor="#54D8F0" stopOpacity={0} />
                </linearGradient>
              </defs>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.05)" />
              <XAxis dataKey="month" {...axisProps} />
              <YAxis {...axisProps} width={48} tickFormatter={(v) => formatCompact(Number(v))} />
              <Tooltip content={<ChartTooltip />} cursor={{ stroke: "#54D8F0", strokeOpacity: 0.2 }} />
              <Area
                type="monotone"
                dataKey="earnings"
                name="earnings"
            ...
            >
              <defs>
                <linearGradient id="refGrad" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#54D8F0" stopOpacity={1} />
                  <stop offset="100%" stopColor="#0090FC" stopOpacity={0.7} />
                </linearGradient>
              </defs>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.05)" />
              <XAxis dataKey="month" {...axisProps} />
