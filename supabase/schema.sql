...
create table if not exists public.brokers (
  ...
  spread_from        numeric(5,2),
  leverage_max       text,
  bonus_no_deposit   boolean not null default false,
  bonus_withdrawable boolean not null default false,
  supports_gold      boolean not null default false,
...
-- ===========================================================================
-- CAMPAIGNS  (live broker offers — mirrors migration 0016)
-- ===========================================================================
...
-- ===========================================================================
-- COUPONS  (promo codes hub — mirrors migration 0018)
-- ===========================================================================
